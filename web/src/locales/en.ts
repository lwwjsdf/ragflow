...
Example: Virtual Hosted Style`,
    ...
    fileManager: {
      ...
      uploadLimit:
        'Each file must not exceed 30MB, and the total number of files must not exceed 128.',
